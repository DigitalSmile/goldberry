...
class ChartsGoldenTest {
    ...
    private static List<Series> two() {
        return List.of(
                Series.of("Cache", 40, 52, 44, 61, 58),
                Series.of("Origin", 12, 9, 15, 11, 14));
    }
    ...
    private void paint(String name, Widget chart) {
        ...
        GoldenImage.assertMatches(name, 320, 180, 1.0f,
    ...
    void inflateFromKdl() {
        ...
        assertEquals(List.of(1200.0, 3400.0), ((BarChart) bar).series().getFirst().values());
    }

    @Test
    @DisplayName("a donut of three slices")
    void donutGolden() {
        paint("donut-chart-dark", new io.github.digitalsmile.goldberry.widgets.data.donutchart
                .DonutChart(List.of(
    ...
    void aDonutKnowsWhatItIsNotFor() {
        ...
        var few = assertThrows(IllegalArgumentException.class,
                () -> new io.github.digitalsmile.goldberry.widgets.data.donutchart.DonutChart(two));
        var many = assertThrows(IllegalArgumentException.class,
    ...
    void aDonutAlwaysNamesItsSlices() {
        ...
        assertTrue(donut.children().getLast()
