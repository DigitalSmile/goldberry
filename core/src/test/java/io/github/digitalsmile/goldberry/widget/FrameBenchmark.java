...
class FrameBenchmark {
    ...
    /// is selected.
    private static Widgets.Attributes classed(String name) {
        return new Widgets.Attributes(null, java.util.Set.of(name), null);
    }
    ...
    private static Widget showcaseTree() {
        return new Widgets.Column(List.of(
                new Widgets.Panel(List.of(
                        new Widgets.Row(List.of(
                                new Widgets.Text("Goldberry"),
                                new Widgets.Spacer(),
                                new Widgets.Text("Nord dark")),
                                Widgets.Attributes.NONE)),
                        classed("bar")),
                new Widgets.Row(List.of(
                        new Widgets.Panel(List.of(
                                new Widgets.Column(List.of(
                                        new Widgets.Text("Overview"),
                                        new Widgets.Text("Controls"),
                                        new Widgets.Text("Motion")),
                                        Widgets.Attributes.NONE)),
                                classed("sidebar")),
                        new Widgets.Column(List.of(
                                new Widgets.Text("Retained rendering"),
                                new Widgets.Text(PROSE)),
                                classed("body"))),
                        Widgets.Attributes.NONE)),
                classed("root"));
    }
