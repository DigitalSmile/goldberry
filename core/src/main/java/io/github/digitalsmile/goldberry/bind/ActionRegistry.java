...
public final class ActionRegistry {
    ...
    /// ActionRegistry that are told which one — see [#bind(String, Consumer)].
    ///
    ...
    private ActionRegistry(boolean strict) {
        this.strict = strict;
    }
    ...
    public static ActionRegistry strict() {
        return new ActionRegistry(true);
    }
    ...
    public static ActionRegistry lenient() {
        return new ActionRegistry(false);
    }

    /// No actions at all, and no complaints. What `Widgets.inflater()` uses.
    public static ActionRegistry none() {
        return lenient();
    }
    ...
    ///         button
    public ActionRegistry bind(String name, Runnable action) {
    ...
    public ActionRegistry bind(String name, Consumer<String> action) {
        Objects.requireNonNull(name, "name");
        Objects.requireNonNull(action, "action");
    ...
    public ActionRegistry rebind(String name, Consumer<String> action) {
        Objects.requireNonNull(name, "name");
        byName.remove(name);
